...
class ModuleOrderView(CsrfExemptMixin, JsonRequestResponseMixin, View):
    def post(self, request):
        for id, oreder in self.request_json.items():
            Module.objects.filer(id=id, course__owner=request.user).update(order=order)
...
class CourseListView(TemplateResponseMixin, View):
    ...
    def get(self, request, subject=None):
        ...
        return self.render_to_response({'subject': subject, 'courses': courses, 'subjects': subjects })
